    ...
    <div>
      <div className='flex items-center border-b border-b-gray-200 py-4'>
        ...
        <div className='flex-grow pl-4'>
          <div className='mb-1 truncate font-semibold text-gray-600'>vdhai</div>
      ...
      <div className='mt-7'>
        ...
        <Link to={path.changePassword} className='transition-color mt-4 flex items-center capitalize text-gray-600'>
          <div className='mr-3 h-[22px] w-[22px]'>
            <img src='https://cf.shopee.vn/file/ba61750a46794d8847c3f463c5e71cc4' alt='' className='h-full w-full' />
          </div>
          Đổi mật khẩu
