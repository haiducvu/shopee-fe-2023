...
const profile =
  '{"_id":"6374a6115fdc5f037e6f694b","roles":["User"],"email":q@merry.com","createdAt":"2022-11-16T08:57:53.872Z","updatedAt":"2022-12-05T06:55:57.846Z","__v":0,"date_of_birth":"1997-01-13T17:00:00.000Z","name":"Hai 3","address":"HCM, Vietnam","avatar":"44f75461-560e-42b5-a9d7-2b833a9f4d67.jpg","phone":"11111111111"}'
...
describe('refresh_token', () => {
  it('refresh_token được set vào localStorage', () => {
    ...
    expect(getAccessRefreshTokenFromLS()).toEqual(refresh_token)
  })
})
...
describe('clearLS', () => {
  it('Xóa hết access_token, refresh_token, profile', () => {
    ...
    expect(getAccessRefreshTokenFromLS()).toBe('')
  })
})
